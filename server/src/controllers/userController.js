...
function computePatientCompletion(user) {
...
function computeCaregiverCompletion(user) {
...
function sanitize(user) {
  ...
  if (user.role === ROLES.PATIENT) {
    plain.profile_completion = computePatientCompletion(user);
  } else if (user.role === ROLES.CAREGIVER) {
    plain.profile_completion = computeCaregiverCompletion(user);
  }
