...
import {
  ...
  CheckCircle2, ClipboardList, Plus, Star, Info, ShieldAlert, Wallet,
} from 'lucide-react';
              ...
              <div className="mt-5 space-y-2.5">
                ...
                {cgCanAccept && (
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    <Button variant="outline" icon={X} loading={busy} onClick={() => act('decline', { reason: 'Not available' })}>Decline</Button>
                  </div>
                )}
                ...
                {patientCanCancel && <Button variant="ghost" icon={X} className="w-full text-danger" loading={busy} onClick={() => act('cancel')}>Cancel booking</Button>}
              </div>
            </CardBody>
          </Card>
